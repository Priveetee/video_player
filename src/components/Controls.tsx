// src/components/Controls.tsx - VERSION FINALE FONCTIONNELLE
import {
  Play,
  Pause,
  Volume2,
...
export const Controls = ({
  ...
  return (
    <>
      ...
      {/* Contrôles centraux mobile - ultra minimalistes */}
      {state.showControls && (
      ...
      {/* Overlay et contrôles principaux */}
      {state.showControls && (
        <div className="absolute inset-0 pointer-events-none">
          {/* Gradient */}
          <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-black/20 pointer-events-none" />

          {/* Bouton fullscreen en haut */}
